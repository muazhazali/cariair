  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: t('registerError'),
        description: error.message || t('registerFailed'),
      });
    } finally {
      setIsLoading(false);
    }
  ...
  const handleGoogleLogin = async () => {
    ...
    try {
      ...
      toast({
        variant: "destructive",
        title: t('registerError'),
        description: error.message || t('registerGoogleFailed'),
      });
    } finally {
      setIsLoading(false);
    }
      ...
      <div className="w-full max-w-md">
        ...
        <Card className="w-full border-2 border-gray-200 dark:border-gray-800 shadow-lg">
          <CardHeader className="space-y-1">
            <CardTitle className="text-xl font-bold text-center">{t('createAccount')}</CardTitle>
